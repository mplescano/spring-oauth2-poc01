...
INSERT INTO users(id, first_name, last_name, roles, username, password, enabled, created_at) VALUES (2, 'Tom', 'Duncan', 'ROLE_ADMIN', 'tom', '111', FALSE, '2016-12-23 17:30:51');
INSERT INTO users(id, first_name, last_name, roles, username, password, enabled, created_at) VALUES (3, 'Keith', 'Andrews', 'ROLE_USER', 'user1', 'pass', FALSE, '2016-06-04 23:53:59');
INSERT INTO users(id, first_name, last_name, roles, username, password, enabled, created_at) VALUES (4, 'Karen', 'Moreno', 'ROLE_ADMIN', 'admin', 'nimda', FALSE, '2016-02-08 02:37:11');
INSERT INTO users(id, first_name, last_name, roles, username, password, enabled, created_at) VALUES (4, 'Bill', 'Bill', 'ROLE_ADMIN', 'bill', 'abc123', FALSE, '2016-02-08 02:37:11');
INSERT INTO users(id, first_name, last_name, roles, username, password, enabled, created_at) VALUES (4, 'Bob', 'Bob', 'ROLE_USER', 'bob', 'abc123', FALSE, '2016-02-08 02:37:11');
